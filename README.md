...
> **Repo note:** the product began as "CareRounds" and was rebranded to
> **CareRounds** (pivot completed 2026-06-23; folder + GitHub repo renamed
> 2026-07-08). A few internal `carerounds` identifiers are deliberately
> kept — see the top banner of [`CLAUDE.md`](CLAUDE.md) before "fixing"
> any. Published under **Juno Code Studio** at **carerounds.care**.
...
One env-configured script that builds + installs CareRounds to a device.
...
Rebranded from "CareRounds" to **CareRounds** and shipped as a standalone
