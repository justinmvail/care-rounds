...
export const profiles = sqliteTable(
  'profiles',
  {
    ...
    careroundsUserId: text('carerounds_user_id').notNull(),
  },
  (t) => [
    uniqueIndex('profiles_carerounds_user_id_unique').on(t.careroundsUserId),
...
// `carerounds_user_id`). The device NEVER decides its own entitlement: it
...
export const entitlements = sqliteTable(
  'entitlements',
  {
    // The forum JWT sub / carerounds_user_id. One entitlement per user.
