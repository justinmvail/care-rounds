...
void main() {
  ...
  group('BundledTTSProvider', () {
    ...
    test('channelName matches the carerounds/tts contract', () {
      expect(BundledTTSProvider.channelName, 'carerounds/tts');
      expect(bundledTtsChannelName, 'carerounds/tts');
    });
      ...
      test(
        ...
        () async {
          ...
          expect(probeCalls.single.method, 'probe',
              reason: 'factory probes via the carerounds/tts probe verb');
        },
      );
    });
