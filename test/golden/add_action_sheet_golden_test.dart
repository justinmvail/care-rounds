...
import 'package:carerounds/widgets/home/add_action_sheet.dart';
...
/// pulls its brand colors directly off `careroundsColors`.
Widget _host(Widget child) => ProviderScope(
      child: Container(
        width: 390,
        color: careroundsColors.background,
        child: Material(color: careroundsColors.background, child: child),
      ),
    );
