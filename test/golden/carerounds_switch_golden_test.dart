...
/// Preview of [CareRoundsSwitch] (fb 2026-06-14 — clearer on/off toggles):
            ...
            children: <Widget>[
              Row(
                children: const <Widget>[
                  CareRoundsSwitch(value: false, onChanged: _noop),
                  SizedBox(width: 24),
                  CareRoundsSwitch(value: true, onChanged: _noop),
                ],
              ),
...
void main() {
  group('CareRoundsSwitch golden', () {
    goldenTest(
      'on/off states + in settings rows',
      fileName: 'carerounds_switch',
