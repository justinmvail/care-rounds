...
///
/// These drive the *real* [CareRoundsApp] over the shared Phase 15
...
import 'package:carerounds/providers/community_feed_provider.dart';
import 'package:carerounds/providers/guidelines_acknowledged_provider.dart';
import 'package:carerounds/providers/my_forum_profile_provider.dart'
    show forumAdminRole;
import 'package:carerounds/screens/community/admin_reports_screen.dart';
import 'package:carerounds/screens/community/community_feed_screen.dart';
import 'package:carerounds/screens/community/post_compose_screen.dart';
...
Future<ProviderContainer> _pumpCommunity(
  ...
  final ProviderContainer container = await pumpCareRoundsApp(
    tester,
    extraOverrides: <Override>[
