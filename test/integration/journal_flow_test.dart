...
import 'package:carerounds/providers/journal_entries_provider.dart';
import 'package:carerounds/providers/storage_provider.dart';
import 'package:carerounds/routing/router.dart';
import 'package:carerounds/screens/journal/journal_entry_screen.dart';
...
void main() {
  ...
  group('Journal — week summary (Phase 15.11)', () {
    testWidgets(
      ...
      final ProviderContainer container =
          await pumpCareRoundsApp(tester, extraOverrides: journalOverrides());
  ...
  group('Journal — wizard end-to-end (Phase 15.11)', () {
    testWidgets('wizard → when / situation / attempts → Save → back on list',
      ...
      unawaited(container.read(careroundsRouterProvider).push('/journal/new'));
      await tester.pumpAndSettle();
