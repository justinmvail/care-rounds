...
void main() {
  group('pumpCareRoundsApp (TASKS.md Phase 15.1)', () {
    ...
    testWidgets('a custom clock override holds (evening greeting)',
        (WidgetTester tester) async {
      await pumpCareRoundsApp(tester, clock: DateTime(2026, 6, 1, 20, 0));
    ...
    testWidgets('returns a usable container the test can read providers from',
        (WidgetTester tester) async {
      final ProviderContainer container = await pumpCareRoundsApp(tester);
