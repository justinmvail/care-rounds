...
import 'package:carerounds/screens/appointment/appointment_detail_screen.dart';
...
/// Their backends call `CareRoundsDatabase.open()` (the real on-disk
...
void main() {
  ...
  group('Appointment CRUD — empty state (Phase 15.7)', () {
    testWidgets('Medical → Appointments shows the empty body, no sections',
      ...
      await pumpCareRoundsApp(tester, extraOverrides: _formOverrides());
