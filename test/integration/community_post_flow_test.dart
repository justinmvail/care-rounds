...
import 'package:carerounds/screens/community/post_detail_screen.dart';
...
import 'package:carerounds/widgets/community/comment_thread.dart';
...
void main() {
  group('Community post detail — Phase 15.12', () {
    ...
    testWidgets('upvote toggles the count and the arrow highlight',
      ...
      expect(_upvoteColor(tester), careroundsColors.primarySoft);
      ...
      expect(_upvoteColor(tester), careroundsColors.cta);
    ...
    testWidgets('upvote then downvote clears the up, highlights the down, -2',
      ...
      expect(_upvoteColor(tester), careroundsColors.primarySoft);
      expect(_downvoteColor(tester), careroundsColors.primary);
