...
import 'package:carerounds/main.dart' show CrashLog;
import 'package:carerounds/providers/auth_provider.dart';
import 'package:carerounds/providers/voice_capture_provider.dart';
import 'package:carerounds/services/feedback_service.dart';
import 'package:carerounds/services/log_buffer.dart';
import 'package:carerounds/theme.dart';
import 'package:carerounds/widgets/feedback/feedback_sheet.dart';
...
void main() {
  ...
  testWidgets(
    ...
    final CareRoundsSwitch toggle = tester.widget<CareRoundsSwitch>(
