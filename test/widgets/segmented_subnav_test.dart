...
import 'package:carerounds/widgets/segmented_subnav.dart';
...
void main() {
  ...
  group('SegmentedSubnav — active state', () {
    testWidgets('defaults to activeIndex 0', (WidgetTester tester) async {
      ...
      expect(_labelStyle(tester, 'Feed')?.color, careroundsColors.background);
      expect(_labelStyle(tester, 'Learn')?.color, careroundsColors.text);
      expect(_labelStyle(tester, 'Support')?.color, careroundsColors.text);
    });
    ...
    testWidgets('honors an explicit activeIndex',
      ...
      expect(_labelStyle(tester, 'Feed')?.color, careroundsColors.text);
      expect(_labelStyle(tester, 'Learn')?.color, careroundsColors.background);
      expect(_labelStyle(tester, 'Support')?.color, careroundsColors.text);
    });
    ...
    testWidgets('active pill fills navy; inactive fills warm white',
      ...
      expect(fills, contains(careroundsColors.primary));
      expect(fills, contains(careroundsColors.surfaceWarm));
    });
  });
