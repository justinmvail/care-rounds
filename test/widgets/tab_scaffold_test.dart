  ...
  group('TabScaffoldBar — standalone widget', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(iconColor(Icons.volunteer_activism), careroundsColors.primary);
        // …inactive tabs show their outlined glyph in primarySoft.
        expect(iconColor(Icons.home_outlined), careroundsColors.primarySoft);
        expect(
          iconColor(Icons.chat_bubble_outline),
          careroundsColors.primarySoft,
        );
      },
    );
