...
/// Six tiles drawn from a spread of [CareRoundsColors] chip tokens —
...
List<HubTile> _sixTiles({VoidCallback? onTap}) => <HubTile>[
      HubTile(
        ...
        chipColor: careroundsColors.primary,
        onTap: onTap ?? () {},
      ),
      HubTile(
        ...
        chipColor: careroundsColors.cta,
        onTap: onTap ?? () {},
      ),
      HubTile(
        ...
        chipColor: careroundsColors.accentDeep,
        onTap: onTap ?? () {},
      ),
      HubTile(
        ...
        chipColor: careroundsColors.link,
        onTap: onTap ?? () {},
      ),
      HubTile(
        ...
        chipColor: careroundsColors.success,
        onTap: onTap ?? () {},
      ),
      HubTile(
        ...
        chipColor: careroundsColors.primarySoft,
        onTap: onTap ?? () {},
      ),
    ];
...
void main() {
  group('HubTile — rendering', () {
    ...
    testWidgets('icon renders at 32px with the default warm-white tint',
      ...
      expect(icon.size, 32);
      expect(icon.color, careroundsColors.background);
    });
    ...
    testWidgets('honors an explicit iconColor override',
        ...
        MaterialApp(
          home: Scaffold(
            body: HubTile(
              ...
              label: 'Appointments',
              subLabel: 'calendar & visits',
              chipColor: careroundsColors.surfaceWarm,
              iconColor: careroundsColors.primary,
              onTap: () {},
            ),
          ),
        ),
      ...
      final Icon icon = tester.widget<Icon>(find.byIcon(Icons.event_outlined));
      expect(icon.color, careroundsColors.primary);
    });
    ...
    testWidgets('label is 15.5pt bold navy; sub-label is 11pt body text',
      ...
      expect(label.style?.color, careroundsColors.primary);

      final Text sub = tester.widget<Text>(find.text('doses & reminders'));
      expect(sub.style?.fontSize, 11);
      expect(sub.style?.color, careroundsColors.text);
    });
    ...
    testWidgets('the chip paints with the supplied chipColor',
      ...
      final bool hasChip = containers.any((Container c) {
        ...
        return d is BoxDecoration && d.color == careroundsColors.success;
      });
