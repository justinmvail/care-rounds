...
import 'package:carerounds/models/care_task.dart';
...
import 'package:carerounds/providers/sync_state_provider.dart';
import 'package:carerounds/services/appointment_repository.dart';
import 'package:carerounds/services/chat_repository.dart';
import 'package:carerounds/services/fake_forum_api_client.dart';
...
import 'package:carerounds/services/sync_service.dart';
import 'package:carerounds/services/sync_sink.dart';
...
class _Device {
  ...
  late final CareRoundsDatabase db;
  ...
  group('a circle the backend no longer has must not wedge sync forever '
    ...
    test('a 404 on the bound circle unbinds, re-bootstraps, and syncs again',
      ...
      SharedPreferences.setMockInitialValues(<String, Object>{
        'carerounds.sync.circle_id': 'dead-circle-from-old-backend',
      });
