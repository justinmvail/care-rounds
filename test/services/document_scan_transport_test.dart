import 'package:carerounds/services/document_scan_transport.dart';
import 'package:flutter_test/flutter_test.dart';

/// Every AI feature that returns structure — the ambient visit note, the
/// care-plan suggestions, the label scanners — funnels through
...
/// (20 spoken visit narrations, 2026-07-29): the model reliably strays on the
...
void main() {
  ...
  group('jsonMapFromText — the model\'s misplaced-quote tic', () {
    test('recovers a string value whose key lost its closing quote', () {
      // Verbatim from the V8-skin narration.
      final Map<String, dynamic>? m = jsonMapFromText('''
Here is the structured visit note:
...
''');
    ...
    test('recovers a list value whose first element lost its opening quote',
        () {
      // Verbatim from the V18-home-safety narration.
      final Map<String, dynamic>? m = jsonMapFromText('''
{
