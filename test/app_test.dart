...
Future<TextScaler> _pumpAndReadScaler(
  ...
  // `careroundsRouterProvider`'s auth-stream subscription — the
...
void main() {
  group('CareRoundsApp — font scaler (BUILD_SPEC.md §11.3)', () {
    ...
    testWidgets(
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: CareRoundsApp(router: probeRouter),
        ),
      );
      await tester.pump();
