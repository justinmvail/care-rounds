...
void main() {
  group('CareRoundsDatabase.testInstance() (TASKS.md Phase 15.2)', () {
    late CareRoundsDatabase db;

    setUp(() {
      db = CareRoundsDatabase.testInstance();
    });
    ...
    test('multiple instances are independent — no shared on-disk file',
        () async {
      final CareRoundsDatabase other = CareRoundsDatabase.testInstance();
