...
import 'package:carerounds/screens/team/circle_qr_screen.dart';
import 'package:carerounds/screens/team/circle_scan_screen.dart';
...
void main() {
  ...
  testWidgets('non-carerounds payload shows a friendly invalid message',
      (tester) async {
