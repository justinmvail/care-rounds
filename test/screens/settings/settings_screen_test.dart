...
import 'package:carerounds/providers/bundled_tts_provider.dart';
import 'package:carerounds/providers/settings_provider.dart';
import 'package:carerounds/providers/storage_provider.dart';
import 'package:carerounds/widgets/carerounds_switch.dart';
...
Future<({InMemoryStorageProvider storage, ProviderContainer container})>
  ...
  // Bumped from 2600 when the "Clients" section (Issue #6) was added,
...
/// Snapshot the value of the CareRoundsSwitchListTile at [key]. Keeps the
...
bool _switchValue(WidgetTester tester, Key key) {
  return tester.widget<CareRoundsSwitchListTile>(find.byKey(key)).value;
}
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(_switchValue(tester, SettingsScreen.notificationsToggleKey),
            isTrue);
        final CareRoundsSwitchListTile remindersTile = tester.widget<CareRoundsSwitchListTile>(
