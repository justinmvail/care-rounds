# JNI bridge — carerounds_espeak_ng
...
android/app/src/main/cpp/
  ...
  carerounds_espeak_ng.cpp   ← committed; JNI shim, __has_include guarded
  README.md                   ← this file
...
`carerounds_espeak_ng.cpp` short-circuits — every native call returns
...
`libcarerounds_espeak_ng.so`; it just doesn't carry espeak-ng.
...
`carerounds_espeak_ng.cpp` exposes four native methods bound to
`com.carerounds.carerounds.EspeakNGNative` (a Kotlin `object`):
