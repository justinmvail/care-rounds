...
//
// Mirror of ios/Runner/TTSBridge.swift's #if CAREROUNDS_HAS_ESPEAK_NG
...
#define CAREROUNDS_HAS_ESPEAK_NG 1
#else
#define CAREROUNDS_HAS_ESPEAK_NG 0
#endif
...
Java_com_carerounds_carerounds_EspeakNGNative_nativeHasEspeakNG(
    JNIEnv* /* env */, jobject /* thiz */) {
#if CAREROUNDS_HAS_ESPEAK_NG
    return JNI_TRUE;
#else
    return JNI_FALSE;
#endif
...
Java_com_carerounds_carerounds_EspeakNGNative_nativeInitialize(
...
Java_com_carerounds_carerounds_EspeakNGNative_nativeTextToPhonemes(
...
Java_com_carerounds_carerounds_EspeakNGNative_nativeTerminate(
    JNIEnv* /* env */, jobject /* thiz */) {
#if CAREROUNDS_HAS_ESPEAK_NG
    espeak_Terminate();
#endif
