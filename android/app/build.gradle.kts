...
android {
    namespace = "com.carerounds.carerounds"
    ...
    defaultConfig {
        ...
        applicationId = "com.carerounds.carerounds"
    ...
    // libcarerounds_espeak_ng.so. On a fresh checkout (no vendor
    ...
    signingConfigs {
        ...
        // CareRounds release keystore (its SHA-1 is registered on the Google
