...
> **Current as of the pivot + tool-action refactor.** CareRounds is
...
> Decoder and the Dr. Natali / Dementia CareRounds framing are gone. The
...
(Home · Care · Chat · Community) against an in-memory `CareRoundsDatabase`
