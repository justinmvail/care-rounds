...
import 'package:carerounds/providers/circle_member_cache_provider.dart'
    show CircleMemberCacheRepository, circleMemberCacheRepositoryBackendProvider;
import 'package:carerounds/providers/supervisor_flags_provider.dart'
    show SupervisorFlagsRepository, supervisorFlagsRepositoryBackendProvider;
import 'package:carerounds/seed/demo_dataset.dart' show seedDemoDataset;
...
import 'package:carerounds/providers/documents_provider.dart';
import 'package:carerounds/providers/expenses_provider.dart';
...
import 'package:carerounds/providers/settings_provider.dart';
...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ProviderContainer container = ProviderContainer(
        overrides: <Override>[
          ...
          circleMemberCacheRepositoryBackendProvider
              .overrideWithValue(CircleMemberCacheRepository(db)),
          supervisorFlagsRepositoryBackendProvider
              .overrideWithValue(SupervisorFlagsRepository(db)),
          forumApiClientProvider.overrideWithValue(_demoForumClient()),
        ],
      );
      addTearDown(container.dispose);

      // Full workforce demo dataset — clients, today's visit route, team,
      // supervisor flags — so Home + My Rounds render populated.
      await seedDemoDataset(container, clock: _fixedNow);
      ...
      await _hold(tester, 1.0);
      await binding.takeScreenshot('06_rounds');
    },
