...
// `carerounds/document_import` MethodChannel — lets "Restore from backup"
// (Settings → Your data) pull a previously-exported CareRounds JSON backup
...
enum DocumentPickerBridge {
    ...
    static let channelName = "carerounds/document_import"
    ...
    static func register(with registry: FlutterPluginRegistry) {
        guard let registrar = registry.registrar(forPlugin: "CareRoundsDocumentImport") else {
            return
        }
