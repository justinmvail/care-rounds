...
///
/// This gate is the defense against a tapped `carerounds://join/<x>`
...
/// Processes care-circle invite deep links (`carerounds://join/<token>` and
/// the QR-style `carerounds:circle:<token>`). Pure of any widget/navigation
