...
/// Play Console — see [CareRoundsProductIds]); the app just reflects whatever
...
class CareRoundsProductIds {
  CareRoundsProductIds._();

  /// Monthly auto-renewing subscription (placeholder — set the real id in
  /// App Store Connect / Play Console).
  static const String monthly = 'com.carerounds.premium.monthly';
  ...
  static const String annual = 'com.carerounds.premium.annual';
...
abstract class BillingService {
  ...
  /// Fetch the [SubscriptionOffering]s for [CareRoundsProductIds.all] from the
...
class SubscriptionOffering {
  ...
  /// Store product id (matches a [CareRoundsProductIds] value).
  final String id;
...
class StoreBillingService implements BillingService {
  StoreBillingService({
    InAppPurchase? iap,
    Set<String> productIds = CareRoundsProductIds.all,
