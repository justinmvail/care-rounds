...
class FakeForumApiClient extends ForumApiClient {
  ...
  /// provider's user maps to `carerounds_user_id = 'demo-user'`.
  static const String _demoUserCareRoundsId = 'demo-user';
  static const String _demoProfileId = 'demo-profile';

  void _seedDemoData() {
    final DateTime now = _clock();
    _profiles[_demoUserCareRoundsId] = ForumProfile(
      id: _demoProfileId,
      careroundsUserId: _demoUserCareRoundsId,
      displayName: 'You',
    ...
    final ForumProfile rob = ForumProfile(
      id: 'profile-rob',
      careroundsUserId: 'seed-rob',
      displayName: 'Rob D.',
      joinedAt: now.subtract(const Duration(days: 90)),
      role: 'user',
    );
    _profiles[sarah.careroundsUserId] = sarah;
    _profiles[mei.careroundsUserId] = mei;
    _profiles[rob.careroundsUserId] = rob;
  ...
  ForumProfile _resolveMyProfile() {
    final ForumProfile? p = _profiles[_demoUserCareRoundsId];
    if (p != null) return p;
    ...
    _profiles[_demoUserCareRoundsId] = fresh;
    return fresh;
  }
  ...
  Future<ForumProfile> updateMyProfile({
    ...
    final ForumProfile next = ForumProfile(
      id: current.id,
      careroundsUserId: current.careroundsUserId,
    ...
    _profiles[current.careroundsUserId] = next;
    return next;
  }
