...
/// `carerounds:circle:<token>` payload, redeems it via
...
class _CircleScanScreenState extends ConsumerState<CircleScanScreen> {
  ...
  /// Extract the token from a `carerounds:circle:<token>` payload (or the
  /// link-style `carerounds://join/<token>`), or null if it isn't one of
