...
import '../../routing/router.dart' show CareRoundsRoutes;
    ...
    return Scaffold(
      ...
      floatingActionButton: onFeed
          ? FloatingActionButton.extended(
              ...
              onPressed: () =>
                  context.pushNamed(CareRoundsRoutes.communityCompose),
                ...
                trailing: (isAdmin && onFeed)
                    ? IconButton(
                        ...
                        onPressed: () => context.pushNamed(
                          CareRoundsRoutes.communityAdminReports,
                        ),
                      )
                    : null,
              ),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () => context.goNamed(
            CareRoundsRoutes.communityPostDetail,
