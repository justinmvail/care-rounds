...
const String databaseFileName = 'carerounds.sqlite';
...
const String kLegacyDatabaseKeyStorageKey = 'carerounds.db.sqlcipher_key.v1';
...
///
/// Lazily connected so `CareRoundsDatabase.open()` stays a synchronous factory.
