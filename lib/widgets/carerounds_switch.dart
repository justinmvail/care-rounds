...
class CareRoundsSwitch extends StatelessWidget {
  const CareRoundsSwitch({
    super.key,
    required this.value,
  ...
  Widget build(BuildContext context) {
    final CareRoundsColors hc = context.hc;
...
/// Drop-in replacement for [SwitchListTile] backed by [CareRoundsSwitch].
/// Tapping anywhere on the row toggles, matching SwitchListTile's behavior;
/// [secondary] maps to the row's leading slot.
class CareRoundsSwitchListTile extends StatelessWidget {
  const CareRoundsSwitchListTile({
    super.key,
    required this.value,
    required this.onChanged,
    this.title,
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: title,
      subtitle: subtitle,
      trailing: CareRoundsSwitch(value: value, onChanged: onChanged),
