...
///
/// - **Active** — navy fill ([CareRoundsColors.primary]), white label,
///   navy border.
/// - **Inactive** — warm-white fill ([CareRoundsColors.surfaceWarm]),
///   slate label ([CareRoundsColors.text]), and a faint brand-line
...
class SegmentedSubnav extends StatelessWidget {
  ...
  /// Navy ([CareRoundsColors.primary]) at ~12% alpha — the brand
