...
///    [CareRoundsColors] by the caller — the HTML reference's
///    coral/teal/amber/plum are placeholders the layout spec explicitly
///    says to discard, so we never adopt them.
/// 2. A **15.5pt bold label** in navy ([CareRoundsColors.primary]).
/// 3. An **11pt sub-label** in body text ([CareRoundsColors.text]).
///
/// The tile is a [surfaceWarm]-filled card with an 18-radius outer
/// corner and a 1.5px brand ([CareRoundsColors.primary]) border, with a
...
class HubTile extends StatelessWidget {
  ...
  /// Chip background behind the icon — a [CareRoundsColors] token chosen
  /// by the caller.
  ...
  /// Icon tint on the chip. Defaults to [CareRoundsColors.background]
