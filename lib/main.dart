...
const String seedDemoTokenPrefsKey = 'carerounds.seed_demo_token';
...
const String careCircleRestampPrefsKey =
    'carerounds.care_circle_restamp_done';
...
const MethodChannel _backupExclusionChannel =
    MethodChannel('carerounds/backup_exclusion');
...
const String resyncAllTokenPrefsKey = 'carerounds.resync_all_token';
...
class CrashLog {
  ...
  static const String fileName = 'carerounds_crash.log';
