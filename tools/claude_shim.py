...
CHAT_CWD = tempfile.mkdtemp(prefix="carerounds-shim-chat-")
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _phonemize(self):
        ...
        Pitch-week interim for the carerounds BundledTTSProvider on iOS
        ...
        try:
            ...
            return self._bad(
                ...
                "piper-phonemize` (the carerounds BundledTTSProvider "
...
def main():
    ...
    print(f"[shim] CareRounds LLM shim listening on http://{HOST}:{PORT}", flush=True)
