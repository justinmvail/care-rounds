...
# locally. (See the carerounds memory "test-server-tailscale-funnel".)
#
# Run every 5 minutes by ~/Library/LaunchAgents/com.carerounds.funnelcert.plist
...
CERTDIR="$HOME/Library/Application Support/carerounds/funnel-cert"
LOG="$HOME/Library/Logs/carerounds-funnel-cert.log"
