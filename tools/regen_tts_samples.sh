...
com.carerounds.carerounds.TTSBridgeInstrumentedTest#regenerateAudioQualitySamples
  popd >/dev/null

  # External app files dir; instrumented test writes here. Path shape:
  # /sdcard/Android/data/com.carerounds.carerounds/files/tts_samples/<voice>/
  REMOTE_BASE="/sdcard/Android/data/com.carerounds.carerounds/files/tts_samples/${VOICE_ID}"
  for slug in "${SCRIPT_SLUGS[@]}"; do
