...
case "$BACKEND" in
  cloudflare-prod) FORUM_API_URL="https://care-rounds-forum.jcsvonellc.workers.dev" ;;
  cloudflare-dev)  FORUM_API_URL="https://care-rounds-forum-dev.jcsvonellc.workers.dev" ;;
...
adb -s "$DEVICE" shell am start -n \
  com.carerounds.carerounds/com.carerounds.carerounds.MainActivity >/dev/null
